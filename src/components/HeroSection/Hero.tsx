            ...
            <div className="container">
                <div className="row pt-5">
                    <div className="col-lg-6 mt-5">
                        ...
                        <p className="text-white">The HRYVNIA-X is a decentralized DeFi Token launched on Binance Smart Chain, community focused. The total supply of „HRYVNIA-X TOKENS“ is 440,000,000 HRYX, it is unchanged.
</p>
                        <div className="text-lg-start text-center">
                            <button className="btn connectBtnHero"
